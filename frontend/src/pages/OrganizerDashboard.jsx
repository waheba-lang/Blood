...
const OrganizerDashboard = () => {
  ...
  if (loading) return <div className="stats-dashboard--center">Chargement...</div>;
      ...
      <header className="campaigns-hero">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <p>Gérez vos campagnes de don de sang</p>
          </div>
            ...
            <div key={campaign.id} className="campaign-card" style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div className="progress-container" style={{ marginTop: 'auto' }}>
                <div className="progress-header">
                  <span><Users size={14} style={{ marginRight: '6px' }} />Inscrits: {campaign.participants_count || campaign.current}</span>
      ...
      {showModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
          <div style={{ background: 'white', padding: '30px', borderRadius: '16px', width: '100%', maxWidth: '800px', maxHeight: '90vh', overflowY: 'auto' }}>
            <h2 style={{ marginBottom: '20px' }}>{editingCampaign ? 'Modifier la campagne' : 'Créer une campagne'}</h2>
